 ...
 */
const ContentBlockImage = ({ title, paragraph1, paragraph2, ctaText, imageSrc, reverse = false }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-6 lg:w-1/2">
          ...
          <motion.p variants={itemVariants} className="text-base text-muted-foreground">
            {paragraph1}
          </motion.p>
