    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-6 sm:p-10 lg:p-12 lg:w-1/2">
          {/* Pill */}
          <motion.div variants={itemVariants} className="bg-card border border-border/50 rounded-full px-4 py-1 text-sm text-primary mb-4 w-fit">
            Start Your Website
          </motion.div>
          ...
          <motion.p variants={itemVariants} className="text-base text-muted-foreground mb-8">
            ...
            portfolio, blog, or eCommerce store, we help turn your vision into a fully
            functional website.
          </motion.p>
        ...
        {/* === Right (Video) Column === */}
        <motion.div variants={videoVariant} className="relative z-10 p-6 sm:p-10 lg:p-12 w-full lg:w-1/2">
          <video
