...
import {
  CpuChipIcon, // Custom UI/UX
  DevicePhoneMobileIcon, // Responsive Layouts
  EyeIcon, // Visual Storytelling
  RectangleGroupIcon, // Intuitive Navigation
  BoltIcon, // Performance Optimization
  BriefcaseIcon, // Website Design Strategy
...
// --- Feature Data (Content updated to Bantern/company voice) ---
const featureData = [
  {
    icon: CpuChipIcon,
...
// --- 1. DEFINING THE SPECIFIC PROCESS DATA (Content updated to Bantern/company voice) ---
const WEBSITE_DESIGN_PROCESS = [
    {
        ...
        description: "Bantern begins by understanding your brand, goals, and audience to establish a strong project foundation.",
        details: [
    ...
    },
    {
        ...
        description: "Bantern creates clear structures and wireframes to map user flow and outline the website’s core framework.",
        details: [
    ...
    },
    {
        ...
        description: "Bantern designs high-quality visual mockups and interactive prototypes aligned with your brand aesthetic.",
        details: [
    ...
    },
    {
        ...
        description: "Bantern develops mobile-first, responsive, and accessible frontend code that brings your design to life.",
        details: [
    ...
    },
    {
        ...
        description: "Bantern performs extensive testing to ensure your website functions flawlessly across all devices.",
        details: [
    ...
    },
    {
        ...
        description: "Bantern deploys your website, conducts final launch checks, and provides full documentation and training.",
        details: [
...
const faqData = [
  {
    ...
    answer: "Ongoing maintenance ensures your website remains secure, optimized, and compatible with the latest technologies. Bantern helps prevent downtime, improve performance, and protect your platform from evolving security risks.",
  },
  {
    id: 2,
    question: "How often do you perform updates?",
    answer: "Bantern performs automated system checks daily and deploys manual updates weekly or immediately when security patches are released, ensuring your website stays safe and up to date.",
  },
  {
    id: 3,
    question: "What happens if my website gets hacked?",
    answer: "Bantern provides emergency recovery, malware removal, security patching, and restoration from clean backups. We secure your website and implement long-term protection measures to prevent future incidents.",
  },
  {
    id: 4,
    question: "Do you provide reports on maintenance activities?",
    answer: "Yes. Bantern provides detailed monthly reports covering updates, performance metrics, security scans, and backup confirmations for complete transparency.",
  },
  {
    id: 5,
    question: "Can I cancel maintenance services anytime?",
    answer: "Yes. Bantern offers flexible monthly billing with no long-term commitments. You may cancel anytime.",
  },
];
    ...
    return (
        <div className="flex flex-col gap-16">
            ...
            <Process 
                ...
                stepsData={WEBSITE_DESIGN_PROCESS} // Pass the newly defined array
            />
